        ...
        while True:
            ...
            if (screen_state != prev_screen_state) or screen_update:
                ...
                if screen_state == 'INIT':
                    ...
                    tft_updater.draw_text(f"Link Quality: {link_quality}    Sats: {num_sats}    HDOP: {HDOP}", (5, 220), text_size=10)
                    tft_updater.update()
                    ...
                    if latest_record:
                        ...
                        tft_updater.draw_text(f"Link Quality: {link_quality}    Sats: {num_sats}    HDOP: {HDOP}", (5, 180), text_size=10)
